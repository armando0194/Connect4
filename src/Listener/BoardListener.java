...
/**
 *  This class handles user input. It determines which board 
...
public class BoardListener implements ActionListener {
	...
	public void actionPerformed(ActionEvent actionEvent) {		
		...
		//Check if it is a draw
			...
			if(gameState.getPlayer(1).getType().equals("Player.ComputerPlayer")){
				computerMakeMove();
			}
		}
		reportTurn();
	...
	/**
	 * Sets the rollover icon and disable icon to every enable button in the board
	 */
